...
adapters_user_data_access_index_mysql = '''const makeUserDb = require('./user-db')
const makeDb = require('../../../infrastructure/user/db')
...
adapters_user_data_access_user_db_mysql = '''const DatabaseError = require('../../../utils/databaseError')
